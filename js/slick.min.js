	...
	(r = (function () {
		...
		function i(t, s) {
			...
			(o.defaults = {
				...
				customPaging: function (d, c) {
					return n('<button type="button"></button>').text(c + 1);
				},
				dots: !1,
				...
				(o.windowTimer = null),
				(a = n(t).data('slick') || {}),
				(o.options = n.extend({}, o.defaults, s, a)),
				...
				(o.autoPlay = n.proxy(o.autoPlay, o)),
				(o.autoPlayClear = n.proxy(o.autoPlayClear, o)),
				(o.autoPlayIterator = n.proxy(o.autoPlayIterator, o)),
				(o.changeSlide = n.proxy(o.changeSlide, o)),
				(o.clickHandler = n.proxy(o.clickHandler, o)),
				(o.selectHandler = n.proxy(o.selectHandler, o)),
				(o.setPosition = n.proxy(o.setPosition, o)),
				(o.swipeHandler = n.proxy(o.swipeHandler, o)),
				(o.dragHandler = n.proxy(o.dragHandler, o)),
				(o.keyHandler = n.proxy(o.keyHandler, o)),
				(o.instanceUid = e++),
				(o.htmlExpr = /^(?:\s*(<[\w\W]+>)[^>]*)$/),
		...
		(r.prototype.addSlide = r.prototype.slickAdd =
			function (e, i, t) {
				...
				s.unload(),
					typeof i == 'number'
						? i === 0 && s.$slides.length === 0
							? n(e).appendTo(s.$slideTrack)
							: t
							? n(e).insertBefore(s.$slides.eq(i))
							: n(e).insertAfter(s.$slides.eq(i))
						: t === !0
						? n(e).prependTo(s.$slideTrack)
						: n(e).appendTo(s.$slideTrack),
			...
			s.animateHeight(),
				...
				s.transformsEnabled === !1
					...
					? (s.options.rtl === !0 && (s.currentLeft = -s.currentLeft),
					  n({ animStart: s.currentLeft }).animate(
							{ animStart: e },
							{
		...
		(r.prototype.buildArrows = function () {
			var e = this;
			e.options.arrows === !0 &&
				((e.$prevArrow = n(e.options.prevArrow).addClass(
					'slick-arrow'
				)),
				(e.$nextArrow = n(e.options.nextArrow).addClass('slick-arrow')),
				e.slideCount > e.options.slidesToShow
					? (e.$prevArrow
			...
			if (
				...
				for (
					e.$slider.addClass('slick-dotted'),
						t = n('<ul></ul>').addClass(e.options.dotsClass),
						i = 0;
					i <= e.getDotCount();
					i += 1
				)
					t.append(
						n('<li></li>').append(
							e.options.customPaging.call(this, e, i)
						)
					);
				(e.$dots = t.appendTo(e.options.appendDots)),
			...
			(e.$slides = e.$slider
				...
				e.$slides.each(function (i, t) {
					n(t)
						...
						.data('originalStyling', n(t).attr('style') || '');
				}),
				e.$slider.addClass('slick-slider'),
				(e.$slideTrack =
					e.slideCount === 0
						? n('<div class="slick-track"></div>').appendTo(
								e.$slider
						  )
						: e.$slides
		...
		(r.prototype.buildRows = function () {
			...
			if (
				...
				for (
					c = e.options.slidesPerRow * e.options.rows,
		...
		(r.prototype.checkResponsive = function (e, i) {
			...
			if (
				(t.respondTo === 'window'
					...
					: t.respondTo === 'slider'
					? (a = c)
					: t.respondTo === 'min' && (a = Math.min(l, c)),
				t.options.responsive &&
					t.options.responsive.length &&
					t.options.responsive !== null)
			) {
				o = null;
				for (s in t.breakpoints)
					t.breakpoints.hasOwnProperty(s) &&
						(t.originalSettings.mobileFirst === !1
							? a < t.breakpoints[s] && (o = t.breakpoints[s])
							: a > t.breakpoints[s] && (o = t.breakpoints[s]));
				o !== null
					? t.activeBreakpoint !== null
						? (o !== t.activeBreakpoint || i) &&
						  ((t.activeBreakpoint = o),
						  t.breakpointSettings[o] === 'unslick'
								? t.unslick(o)
								: ((t.options = n.extend(
										{},
										t.originalSettings,
										t.breakpointSettings[o]
								  )),
								  e === !0 &&
										(t.currentSlide =
											t.options.initialSlide),
								  t.refresh(e)),
						  (d = o))
						: ((t.activeBreakpoint = o),
						  t.breakpointSettings[o] === 'unslick'
					...
					: t.activeBreakpoint !== null &&
					  ...
					  e === !0 && (t.currentSlide = t.options.initialSlide),
					  t.refresh(e),
					  (d = o)),
					!e && d !== !1 && t.$slider.trigger('breakpoint', [t, d]);
			}
		}),
		(r.prototype.changeSlide = function (e, i) {
			...
			switch (
				...
				(d = t.slideCount % t.options.slidesToScroll !== 0),
				(o = d
					? 0
				...
				case 'previous':
					(a =
						o === 0
							? t.options.slidesToScroll
							: t.options.slidesToShow - o),
						t.slideCount > t.options.slidesToShow &&
							t.slideHandler(t.currentSlide - a, !1, i);
					break;
				case 'next':
					(a = o === 0 ? t.options.slidesToScroll : o),
						t.slideCount > t.options.slidesToShow &&
							t.slideHandler(t.currentSlide + a, !1, i);
					break;
				case 'index':
					var c =
						e.data.index === 0
							? 0
							: e.data.index ||
							  s.index() * t.options.slidesToScroll;
					t.slideHandler(t.checkNavigable(c), !1, i),
		...
		(r.prototype.checkNavigable = function (e) {
			var i = this,
				t,
				s;
			if (((t = i.getNavigableIndexes()), (s = 0), e > t[t.length - 1]))
				e = t[t.length - 1];
			else
				for (var o in t) {
					if (e < t[o]) {
		...
		(r.prototype.cleanUpEvents = function () {
			...
			e.options.dots &&
				...
				(n('li', e.$dots)
					...
					.off('mouseenter.slick', n.proxy(e.interrupt, e, !0))
					.off('mouseleave.slick', n.proxy(e.interrupt, e, !1)),
				...
				n(document).off(e.visibilityChange, e.visibility),
				...
				n(window).off('resize.slick.slick-' + e.instanceUid, e.resize),
				n('[draggable!=true]', e.$slideTrack).off(
					'dragstart',
					e.preventDefault
				),
				n(window).off(
		...
		(r.prototype.cleanUpSlideEvents = function () {
			var e = this;
			e.$list.off('mouseenter.slick', n.proxy(e.interrupt, e, !0)),
				e.$list.off('mouseleave.slick', n.proxy(e.interrupt, e, !1));
		}),
		...
		(r.prototype.getLeft = function (e) {
			...
			return (
				(i.slideOffset = 0),
				(s = i.$slides.first().outerHeight(!0)),
				i.options.infinite === !0
					? (i.slideCount > i.options.slidesToShow &&
							...
							i.options.vertical === !0 &&
								...
								(i.options.slidesToShow === 2
									? (d = -1.5)
									: i.options.slidesToShow === 1 && (d = -2)),
							(o = s * i.options.slidesToShow * d)),
					...
					: e + i.options.slidesToShow > i.slideCount &&
					  ((i.slideOffset =
							(e + i.options.slidesToShow - i.slideCount) *
							i.slideWidth),
					  (o = (e + i.options.slidesToShow - i.slideCount) * s)),
				i.slideCount <= i.options.slidesToShow &&
					((i.slideOffset = 0), (o = 0)),
				i.options.centerMode === !0 &&
				i.slideCount <= i.options.slidesToShow
				...
				i.options.variableWidth === !0 &&
					...
					i.options.infinite === !1
						? (a = i.$slideTrack.children('.slick-slide').eq(e))
						: (a = i.$slideTrack
		...
		(r.prototype.getSlideCount = function () {
			...
			return (
				(o =
					e.options.centerMode === !0
						? Math.floor(e.$list.width() / 2)
						: 0),
				(s = e.swipeLeft * -1 + o),
				e.options.swipeToSlide === !0
					? (e.$slideTrack.find('.slick-slide').each(function (a, d) {
							var c, l, p;
							if (
								((c = n(d).outerWidth()),
								(l = d.offsetLeft),
								e.options.centerMode !== !0 && (l += c / 2),
								(p = l + c),
								s < p)
							)
								return (t = d), !1;
					  ...
					  (i =
							Math.abs(
								n(t).attr('data-slick-index') - e.currentSlide
							) || 1),
					  i)
					: e.options.slidesToScroll
			);
					...
					(e.$slides
						...
						.each(function (a) {
							...
							if (
								...
								var c =
									'slick-slide-control' + e.instanceUid + d;
								n('#' + c).length &&
									n(this).attr({ 'aria-describedby': c });
							}
						}),
					e.$dots
						.attr('role', 'tablist')
		...
		(r.prototype.initDotEvents = function () {
			...
			e.options.dots === !0 &&
				...
				e.options.dots === !0 &&
					...
					e.slideCount > e.options.slidesToShow &&
					n('li', e.$dots)
						.on('mouseenter.slick', n.proxy(e.interrupt, e, !0))
						.on('mouseleave.slick', n.proxy(e.interrupt, e, !1));
		}),
		(r.prototype.initSlideEvents = function () {
			var e = this;
			e.options.pauseOnHover &&
				(e.$list.on('mouseenter.slick', n.proxy(e.interrupt, e, !0)),
				e.$list.on('mouseleave.slick', n.proxy(e.interrupt, e, !1)));
		}),
		(r.prototype.initializeEvents = function () {
			...
			e.initArrowEvents(),
				...
				n(document).on(e.visibilityChange, n.proxy(e.visibility, e)),
				e.options.accessibility === !0 &&
				...
				n(window).on(
					'orientationchange.slick.slick-' + e.instanceUid,
					n.proxy(e.orientationChange, e)
				),
				n(window).on(
					'resize.slick.slick-' + e.instanceUid,
					n.proxy(e.resize, e)
				),
				n('[draggable!=true]', e.$slideTrack).on(
					'dragstart',
					e.preventDefault
				),
				n(window).on(
		...
		(r.prototype.lazyLoad = function () {
			...
			function a(f) {
				n('img[data-lazy]', f).each(function () {
					var u = n(this),
						...
						v = n(this).attr('data-srcset'),
						g =
							n(this).attr('data-sizes') ||
							e.$slider.attr('data-sizes'),
						k = document.createElement('img');
					(k.onload = function () {
						u.animate({ opacity: 0 }, 100, function () {
							v && (u.attr('srcset', v), g && u.attr('sizes', g)),
								u
									.attr('src', h)
						...
						(k.onerror = function () {
							u
								...
								e.$slider.trigger('lazyLoadError', [e, u, h]);
						}),
						(k.src = h);
				});
			}
			if (
				(e.options.centerMode === !0
					? e.options.infinite === !0
						? ((s =
								e.currentSlide +
								(e.options.slidesToShow / 2 + 1)),
						  (o = s + e.options.slidesToShow + 2))
						: ((s = Math.max(
								0,
								e.currentSlide -
									(e.options.slidesToShow / 2 + 1)
						  ...
						  (o =
								...
								(e.options.slidesToShow / 2 + 1) +
								e.currentSlide))
					: ((s = e.options.infinite
							? e.options.slidesToShow + e.currentSlide
							: e.currentSlide),
					  (o = Math.ceil(s + e.options.slidesToShow)),
					  e.options.fade === !0 &&
							(s > 0 && s--, o <= e.slideCount && o++)),
				(i = e.$slider.find('.slick-slide').slice(s, o)),
				e.options.lazyLoad === 'anticipated')
			)
				for (
					var d = s - 1,
						c = o,
						l = e.$slider.find('.slick-slide'),
						p = 0;
					p < e.options.slidesToScroll;
					p++
				)
					d < 0 && (d = e.slideCount - 1),
						(i = i.add(l.eq(d))),
						(i = i.add(l.eq(c))),
						d--,
						c++;
			a(i),
				e.slideCount <= e.options.slidesToShow
					? ((t = e.$slider.find('.slick-slide')), a(t))
		...
		(r.prototype.progressiveLazyLoad = function (e) {
			...
			t.length
				? ((s = t.first()),
				  ...
				  (d = s.attr('data-sizes') || i.$slider.attr('data-sizes')),
				  (c = document.createElement('img')),
				  (c.onload = function () {
						a && (s.attr('srcset', a), d && s.attr('sizes', d)),
							s
								.attr('src', o)
								.removeAttr('data-lazy data-srcset data-sizes')
								.removeClass('slick-loading'),
							i.options.adaptiveHeight === !0 && i.setPosition(),
							i.$slider.trigger('lazyLoaded', [i, s, o]),
				  ...
				  (c.onerror = function () {
						e < 3
							...
							: (s
									...
									.removeClass('slick-loading')
									.addClass('slick-lazyload-error'),
							  i.$slider.trigger('lazyLoadError', [i, s, o]),
							  i.progressiveLazyLoad());
				  }),
				  (c.src = o))
		...
		(r.prototype.refresh = function (e) {
			...
			(s = i.slideCount - i.options.slidesToShow),
				...
				(t = i.currentSlide),
				i.destroy(!0),
				n.extend(i, i.initials, { currentSlide: t }),
				i.init(),
				e ||
			...
			if (Array.isArray(o) && o.length) {
				...
				for (i in o)
					if (((s = e.breakpoints.length - 1), o.hasOwnProperty(i))) {
						for (t = o[i].breakpoint; s >= 0; )
							e.breakpoints[s] &&
								e.breakpoints[s] === t &&
								e.breakpoints.splice(s, 1),
								s--;
						e.breakpoints.push(t),
							(e.breakpointSettings[t] = o[i].settings);
					}
		...
		(r.prototype.resize = function () {
			var e = this;
			n(window).width() !== e.windowWidth &&
				(clearTimeout(e.windowDelay),
				(e.windowDelay = window.setTimeout(function () {
					(e.windowWidth = n(window).width()),
						e.checkResponsive(),
					...
					(n.isPlainObject(arguments[0])
						...
						: typeof arguments[0] == 'string' &&
						  ...
						  Array.isArray(arguments[1])
								? (d = 'responsive')
								: typeof arguments[1] < 'u' && (d = 'single')),
					d === 'single')
				)
					e.options[s] = o;
				else if (d === 'multiple')
					n.each(s, function (c, l) {
						e.options[c] = l;
					});
				else if (d === 'responsive')
					for (t in o)
						if (!Array.isArray(e.options.responsive))
							e.options.responsive = [o[t]];
						else {
							for (i = e.options.responsive.length - 1; i >= 0; )
								e.options.responsive[i].breakpoint ===
									o[t].breakpoint &&
		...
		(r.prototype.setSlideClasses = function (e) {
			...
			if (
				...
				e >= 0 && e <= i.slideCount - i.options.slidesToShow
					...
					: ((a = i.slideCount % i.options.slidesToShow),
					  (o =
							i.options.infinite === !0
		...
		(r.prototype.setupInfinite = function () {
			...
			if (
				...
				e.options.infinite === !0 &&
					e.options.fade === !1 &&
					((t = null), e.slideCount > e.options.slidesToShow))
			) {
				for (
					e.options.centerMode === !0
					...
					(t = i - 1),
						n(e.$slides[t])
							.clone(!0)
							.removeAttr('id')
							.attr('data-slick-index', t - e.slideCount)
							.prependTo(e.$slideTrack)
							.addClass('slick-cloned');
				for (i = 0; i < s + e.slideCount; i += 1)
					(t = i),
						n(e.$slides[t])
							.clone(!0)
							.removeAttr('id')
		...
		(r.prototype.selectHandler = function (e) {
			var i = this,
				t = n(e.target).is('.slick-slide')
					? n(e.target)
					: n(e.target).parents('.slick-slide'),
		...
		(r.prototype.slideHandler = function (e, i, t) {
			...
			if (
				...
				if (
					...
					(s = e),
					(c = l.getLeft(s)),
					(d = l.getLeft(l.currentSlide)),
					(l.currentLeft = l.swipeLeft === null ? d : l.swipeLeft),
					...
					l.options.fade === !1 &&
						((s = l.currentSlide),
						t !== !0 && l.slideCount > l.options.slidesToShow
				...
				if (
					...
					l.options.asNavFor &&
						...
						p.slideCount <= p.options.slidesToShow &&
							p.setSlideClasses(l.currentSlide)),
					l.updateDots(),
					l.updateArrows(),
					l.options.fade === !0)
				) {
			...
			if (
				((c =
					e.originalEvent !== void 0
						...
						: null),
				!i.dragging || i.scrolling || (c && c.length !== 1))
			)
				return !1;
			if (
				((s = i.getLeft(i.currentSlide)),
				(i.touchObject.curX = c !== void 0 ? c[0].pageX : e.clientX),
				(i.touchObject.curY = c !== void 0 ? c[0].pageY : e.clientY),
				...
				!i.options.verticalSwiping && !i.swiping && l > 4)
			)
				return (i.scrolling = !0), !1;
			if (
				(i.options.verticalSwiping === !0 &&
					(i.touchObject.swipeLength = l),
				(o = i.swipeDirection()),
				e.originalEvent !== void 0 &&
				...
				i.options.verticalSwiping === !0 &&
					(d = i.touchObject.curY > i.touchObject.startY ? 1 : -1),
				(a = i.touchObject.swipeLength),
				(i.touchObject.edgeHit = !1),
				i.options.infinite === !1 &&
					((i.currentSlide === 0 && o === 'right') ||
						(i.currentSlide >= i.getDotCount() && o === 'left')) &&
					((a = i.touchObject.swipeLength * i.options.edgeFriction),
					(i.touchObject.edgeHit = !0)),
				i.options.vertical === !1
					? (i.swipeLeft = s + a * d)
					: (i.swipeLeft =
							s + a * (i.$list.height() / i.listWidth) * d),
				i.options.verticalSwiping === !0 && (i.swipeLeft = s + a * d),
		...
		(r.prototype.swipeStart = function (e) {
			...
			e.originalEvent !== void 0 &&
				...
				(i.touchObject.startX = i.touchObject.curX =
					t !== void 0 ? t.pageX : e.clientX),
				(i.touchObject.startY = i.touchObject.curY =
					t !== void 0 ? t.pageY : e.clientY),
				(i.dragging = !0);
		}),
		...
		(r.prototype.unload = function () {
			var e = this;
			n('.slick-cloned', e.$slider).remove(),
		...
		(n.fn.slick = function () {
			...
			for (o = 0; o < s; o++)
				if (
					(typeof i == 'object' || typeof i > 'u'
						? (e[o].slick = new r(e[o], i))
						: (a = e[o].slick[i].apply(e[o].slick, t)),
					typeof a < 'u')
				)
					return a;
			return e;
